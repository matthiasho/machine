...
To obtain the prediction for the exercise, I eventually settled for the random forest, method ="rf" provided by the caret package.

The 20 predictions that I submitted for part II are:
